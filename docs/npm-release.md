...
- Date: 2026-06-02.
- Current published version: `jscpd-rs@0.1.7`.
- Latest npm publish workflow: `v0.1.7` GitHub Release workflow.
...
- Post-publication smoke passed from clean temporary directories:
  `npm install jscpd-rs@0.1.7`, `jscpd-rs --version`, `jscpd --version`,
  `jscpd-server --version`, and
  `npx --package jscpd-rs@0.1.7 jscpd-rs --version`.
